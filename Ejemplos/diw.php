  ...
  <form name="expresiones" id="expresiones" action="diw.php" method="post">
    <fieldset>
      ...
      <p>
        ...
        <input type="text" name="exp7" id="exp7" size="50" maxlength="20"
      ...
      <p>
        ...
        <input type="text" name="exp8" id="exp8" size="50" maxlength="20"
